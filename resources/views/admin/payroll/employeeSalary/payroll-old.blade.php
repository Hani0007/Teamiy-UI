...
@section('styles')
<style>
    .payroll-container {font-family: Arial, sans-serif;}
    .payroll-card {background: #fff;border-radius: 12px;padding: 15px;margin-bottom: 15px;box-shadow: 0 2px 8px rgba(0,0,0,0.08);}
    .payroll-title {font-weight: 700;color: #1f4fa3;margin-bottom: 12px;}
    .employee-box {display: flex;align-items: center;gap: 12px;margin-bottom: 12px;}
    .avatar {width: 50px;height: 50px;background: #e3f2fd;color: #1f4fa3;font-weight: bold;font-size: 20px;display: flex;align-items: center;justify-content: center;border-radius: 50%;}
    .info-row {display: flex;justify-content: space-between;font-size: 14px;padding: 4px 0;}
    .net-salary {font-weight: bold;font-size: 16px;color: #1f4fa3;}
            ...
            <div class="card-body">
                <div class="table-responsive">
                    <table id="dataTableExample" class="table">
                        ...
                        @empty
                            <tr><td colspan="100%"><p class="text-center"><b>{{ __('index.no_records_found') }}</b></p></td></tr>
                        @endforelse --}}
