<div class="row">
    ...
    <div class="col-lg-4 col-md-6 mb-4">
        ...
        <select class="form-select" id="branch_id" name="branch_id">
            ...
            @foreach($branch as $value)
                <option value="{{ $value->id }}" {{ (isset($clientDetail) && $clientDetail->branch_id == $value->id) ? 'selected' : '' }}>
                    {{ ucfirst($value->name) }}
                </option>
            @endforeach
        </select>
    ...
    <div class="col-lg-4 col-md-6 mb-4">
        ...
        <div class="input-group phone-group">
            <select class="form-select phone-country" id="client_phone_code" style="max-width: 140px">
    ...
    <div class="col-lg col-md-6 mb-4 mt-md-4 text-start">
