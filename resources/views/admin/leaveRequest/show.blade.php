                ...
                <div class="container">
                   <div class="row">
                        <div class="col-lg-12 mb-2 pb-2 border-bottom">
                            <label for="exampleFormControlSelect1" class="form-label fw-bold">{{ __('index.referred_by') }}</label>
                            <p class="form-control border-0 p-0 fst-italic" style="height:inherit"  id="referredBy"></p>
                        </div>

                    
                        <div class="col-lg-12 mb-2 pb-2 border-bottom">
                            <label for="exampleFormControlSelect1" class="form-label fw-bold">{{ __('index.leave_reason') }}</label>
                            <p class="form-control border-0 p-0 fst-italic" style="height:inherit" id="description"></p>
                        </div>

                    
                        <div class="col-lg-12">
                            <label for="exampleFormControlSelect1" class="form-label fw-bold">{{ __('index.admin_remark') }}</label>
                            <p class="form-control border-0 p-0 fst-italic" style="height:inherit"  id="adminRemark" ></p>
                        </div>
                    </div>
                </div>
        ...
        <div class="modal-content border-0" style="border-radius: 20px; overflow: hidden; box-shadow: 0 10px 30px rgba(0,0,0,0.1);">
            ...
            <div class="modal-body p-4" style="background: #f8fafc;">
                <div class="row g-4">
                    ...
                    <div class="col-12">
                        <div class="d-flex align-items-center p-3" style="background: white; border-radius: 15px; border: 1px solid #e2e8f0;">
                            ...
                            <div class="flex-grow-1">
                                ...
                                <p class="mb-0 fw-600 text-dark" id="referredBy" style="font-size: 14px;"></p>
                            </div>
                        </div>
                    </div>
                    ...
                    {{-- Leave Reason --}}
                    <div class="col-12">
                        <div class="p-3" style="background: white; border-radius: 15px; border: 1px solid #e2e8f0;">
                            <div class="d-flex align-items-center mb-2">
                                <div style="background: rgba(5, 125, 176, 0.1); width: 35px; height: 35px; border-radius: 10px; display: flex; align-items: center; justify-content: center; margin-right: 12px;">
                                    <i data-feather="help-circle" style="color: #057db0; width: 18px;"></i>
                                </div>
                            ...
                            <div class="p-2 ms-1" style="border-left: 2px solid #057db0;">
                                <p class="mb-0 text-secondary fst-italic" id="description" style="font-size: 13px; line-height: 1.6;"></p>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="p-3" style="background: #eff6ff; border-radius: 15px; border: 1px dashed #bfdbfe;">
                            <div class="d-flex align-items-center mb-2">
                                <div style="background: #fff; width: 35px; height: 35px; border-radius: 10px; display: flex; align-items: center; justify-content: center; margin-right: 12px; box-shadow: 0 2px 5px rgba(0,0,0,0.05);">
                                    <i data-feather="message-square" style="color: #057db0; width: 18px;"></i>
                                </div>
                            ...
                            <p class="mb-0 text-dark ps-1" id="adminRemark" style="font-size: 13px; min-height: 20px;"></p>
                        </div>
                    </div>
