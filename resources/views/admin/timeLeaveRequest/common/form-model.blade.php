<div class="modal fade" id="statusUpdate" tabindex="-1" aria-labelledby="statusUpdateLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content border-0 shadow-lg" style="border-radius: 20px; overflow: hidden;">
            ...
            {{-- Modern Glossy Header (Blue Theme) --}}
            <div class="modal-header border-0 position-relative" style="background: linear-gradient(135deg, #057db0 0%, #046690 100%); padding: 25px;">
                ...
                <div class="d-flex align-items-center position-relative" style="z-index: 2;">
                    ...
                    <div>
                        <h5 class="modal-title text-white fw-bold mb-0" id="statusUpdateLabel">{{__('index.time_leave_status_update')}}</h5>
                        <p class="text-white-50 mb-0 small" style="font-size: 11px;">Update employee leave request status</p>
                    </div>
                </div>
                ...
                <form class="forms-sample" id="updateLeaveStatus" action="" method="post">
                    ...
                    <div class="row g-4">
                        ...
                        <div class="col-12">
                            ...
                            <select class="form-select modern-select" id="status" name="status" 
                                    style="border-radius: 12px; padding: 12px; border: 1px solid #e2e8f0; font-weight: 600;">
                        ...
                        <div class="col-12">
                            <label class="form-label fw-bold small text-muted text-uppercase" style="letter-spacing: 0.5px;">
                                {{__('index.admin_remark')}}
                            </label>
                            <textarea class="form-control modern-input" id="remark" minlength="10" name="admin_remark" rows="4" 
                                      placeholder="Write your remarks here..."
                                      style="border-radius: 12px; padding: 12px; border: 1px solid #e2e8f0; resize: none;"></textarea>
                        </div>
                    </div>
                    ...
                    <div class="mt-4 pt-3 border-top d-flex justify-content-end gap-2">
                        <button type="button" class="btn btn-light px-4 fw-bold" data-bs-dismiss="modal" 
                                style="border-radius: 12px; color: #FB8233; border: 1px solid #e2e8f0; min-width: 100px;">
                            {{__('index.cancel')}}
                        </button>
                        <button type="submit" id="submit-btn" class="btn btn-primary px-4 fw-bold" 
                                style="background: linear-gradient(135deg, #057db0 0%, #046690 100%); border: none; border-radius: 12px; min-width: 140px; box-shadow: 0 4px 15px rgba(5, 125, 176, 0.2);">
                            {{__('index.submit')}}
                        </button>
                    </div>
                </form>
