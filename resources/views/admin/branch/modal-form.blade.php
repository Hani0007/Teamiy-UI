                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 mb-4">
                            ...
                            <div class="input-group phone-group">
                                <select class="form-select phone-country" id="branch_modal_phone_code" style="max-width: 140px">
                                ...
                                <input type="tel" class="form-control mobile" required id="phone" name="phone" value="" autocomplete="off" placeholder="{{ __('index.phone_number') }}">
                            </div>
                        </div>
                        ...
                        <div class="col-lg-6 mb-4" style="display: none;">
                            ...
                            <input type="text" class="form-control" id="branch_location_latitude" name="branch_location_latitude" value="" autocomplete="off" placeholder="{{ __('index.enter_branch_location_latitude') }}">
                        </div>

                        <div class="col-lg-6 mb-4" style="display: none;">
                            <label for="branch_location_longitude" class="form-label">{{ __('index.branch_location_longitude') }}</label>
                            <input type="text" class="form-control" id="branch_location_longitude" name="branch_location_longitude" value="" autocomplete="off" placeholder="{{ __('index.enter_branch_location_longitude') }}">
                        </div>
