<div class="row">
    <div class="col-lg-6">
        <div class="row">
            <div class="col-lg-12 mb-4">
                ...
                <input type="text" class="form-control" id="event" required name="event" 
                       value="{{ ( isset($holidayDetail) ? ($holidayDetail->event): old('event') )}}" 
                       autocomplete="off" placeholder="Enter event name">
            </div>
            ...
            <div class="col-lg-12 mb-4">
                ...
                <input class="form-control" name="event_date" 
                       value="{{(isset($holidayDetail) ? ($holidayDetail->event_date): old('event_date') )}}" required
                       @if(\App\Helpers\AppHelper::ifDateInBsEnabled())
                           type="text" id="eventDate" placeholder="yyyy/mm/dd"
                       @else
                           type="date"
                       @endif
                />
    ...
    <div class="col-lg-6 mb-4">
        ...
        <textarea class="form-control" name="note" id="tinymceExample" rows="5">{{ ( isset($holidayDetail) ? $holidayDetail->note: old('note') )}}</textarea>
    </div>
</div>