            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-md-6 mb-3">
                    ...
                    <select class="form-select" id="nationality" name="nationality" required>
                        <option value="" {{ (isset($userDetail) || old('nationality')) ? '' : 'selected' }} disabled>
                            Select
                        </option>
                ...
                <div class="col-lg-4 col-md-6 mb-3">
                    <label for="place_of_birth" class="form-label">Place of Birth <span style="color: #6c757d">(optional)</span></label>
        ...
        <div class="section-heading-text">
            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-md-6 mb-3">
                    ...
                    <select class="form-select @error('branch_id') is-invalid @enderror" id="branch" name="branch_id" required>
                ...
                <div class="col-lg-4 col-md-6 mb-3">
                    <label for="department" class="form-label">{{ __('index.departments') }} <span style="color: red">*</span></label>
                    <select class="form-select @error('department_id') is-invalid @enderror" id="department" name="department_id" required>
                        @if (isset($userDetail->department))
                            <option value="{{ $userDetail->department->id }}" selected>{{ $userDetail->department->dept_name }}</option>
                        @else
                ...
                <div class="col-lg-4 col-md-6 mb-3">
                    ...
                    <select class="form-select @error('post_id') is-invalid @enderror" id="post" name="post_id" required>
                        @if (isset($userDetail->post))
                            <option value="{{ $userDetail->post->id }}" selected>{{ $userDetail->post->post_name }}</option>
                        @else
                        ...
                        @if(isset($userDetail))
                            @foreach($filteredSupervisor as $supervisor)
                                @if( $supervisor->id !== $userDetail->id)
                                    <option
                                        value="{{ $supervisor->id }}" {{ $supervisor->id ==  $userDetail->supervisor_id ? 'selected' : '' }}>
                ...
                <div class="col-lg-4 col-md-6 mb-3">
                    <label for="officeTime" class="form-label ">{{ __('index.office_time') }} <span style="color: red">*</span></label>
                    <select class="form-select @error('office_time_id') is-invalid @enderror" id="officeTime" name="office_time_id" required >
                ...
                <div class="col-lg-4 col-md-6 mb-3">
                    <label for="fiscal_number" class="form-label">Fiscal Number <span style="color: #6c757d">(optional)</span></label>
...
<div class="card mb-4 ">
    <div class="card-body pb-2 teamy-main-card px-5">
        ...
        <div class="section-heading-text">
            ...
            <div class="row">
                <div class="col-lg-4 col-md-6 mb-3">
                    <label for="contract_start_date" class="form-label">Contract Start Date <span style="color: red">*</span></label>
                    <input type="date" class="form-control" id="contract_start_date" name="contract_start_date"
                        value="{{isset($userDetail->contract_start_date) ? $userDetail->contract_start_date : old('contract_start_date')}}" autocomplete="off" placeholder="Select Date" required>
                </div>

                <div class="col-lg-4 col-md-6 mb-3">
                    <label for="contract_end_date" class="form-label">Contract End Date <span style="color: red">*</span></label>
                    <input type="date" class="form-control" id="contract_end_date" name="contract_end_date"
                        value="{{isset($userDetail->contract_end_date) ? $userDetail->contract_end_date : old('contract_end_date')}}" autocomplete="off" placeholder="Select Date" required>
                </div>
                ...
                <div class="col-lg-4 col-md-6 mb-3">
                    ...
                    <input type="text" class="form-control" id="pay_grade" name="pay_grade"
                        value="{{isset($userDetail->pay_grade) ? $userDetail->pay_grade : old('pay_grade')}}" autocomplete="off" placeholder="Enter Pay Grade">
                </div>

                <div class="col-lg-4 col-md-6 mb-3">
                    <label for="contract_type" class="form-label">Contract Type <span style="color: #6c757d">(optional)</span></label>
                    <select class="form-select" id="contract_type" name="contract_type">
                        <option value="" {{isset($userDetail) || old('contract_type') ? '' : 'selected'}} disabled>
                            Select Contract Type
                        </option>
                        <option value="permanent" {{ isset($userDetail) && ($userDetail->contract_type) == 'permanent' || old('contract_type') == 'permanent' ? 'selected' : '' }}>
                            Permanent
                        </option>
                        <option value="temporary" {{ isset($userDetail) && ($userDetail->contract_type) == 'temporary' || old('contract_type') == 'temporary' ? 'selected' : '' }}>
                            Temporary
                        </option>
                        <option value="contract" {{ isset($userDetail) && ($userDetail->contract_type) == 'contract' || old('contract_type') == 'contract' ? 'selected' : '' }}>
                            Contract
                        </option>
                        <option value="internship" {{ isset($userDetail) && ($userDetail->contract_type) == 'internship' || old('contract_type') == 'internship' ? 'selected' : '' }}>
                            Internship
                        </option>
                        <option value="probation" {{ isset($userDetail) && ($userDetail->contract_type) == 'probation' || old('contract_type') == 'probation' ? 'selected' : '' }}>
                            Probation
                        </option>
                    </select>
                </div>
                ...
                <div class="col-lg-6 mb-3 empl-desc">
                    ...
                    <textarea class="form-control" name="additional_notes" id="tinymceExample"
                            rows="2">{{ ( isset($userDetail) ? $userDetail->additional_notes: old('additional_notes') )}}</textarea>
                </div>
            </div>
        </div>
    </div>
