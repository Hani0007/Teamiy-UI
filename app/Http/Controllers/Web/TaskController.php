...
class  TaskController extends Controller
{
    ...
    public function store(TaskRequest $request): RedirectResponse
    {
        ...
        try {
            ...
            $validatedData['start_date'] = Carbon::parse($validatedData['start_date'])->format('Y-m-d H:i');
            $validatedData['end_date'] = Carbon::parse($validatedData['end_date'])->format('Y-m-d H:i');
