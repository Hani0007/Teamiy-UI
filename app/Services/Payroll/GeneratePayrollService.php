...
//                            }
    ...
    public function getCurrentEmployeeSalaries($filterData): array
    {
        try {
            ...
            $employeeSalary  = $this->payslipRepository->getEmployeeCurrentPayslipList($firstDay, $lastDay, $isBsEnabled, $filterData);
