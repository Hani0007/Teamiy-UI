...
class UserUpdateRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'work_email' => ['required','string', Rule::unique('users')->ignore($this->employee)],
            'address' => 'nullable|required_unless:role_id,1',
            'dob' => 'nullable|required_unless:role_id,1|date|before:today',
            'phone' => ['nullable','required_unless:role_id,1'],
            ...
            'contract_type' => 'nullable|string|in:permanent,temporary,contract,internship,probation'
        ];
