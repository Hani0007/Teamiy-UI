...
class TimeLeave extends Model
{
    ...
    protected $fillable = ['issue_date', 'start_time', 'end_time', 'status', 'reasons','avatar', 'admin_remark', 'requested_by','request_updated_by','referred_by','branch_id',
        'department_id', 'company_id'];

    const RECORDS_PER_PAGE = 10;
    const ATTACHMENT_UPLOAD_PATH = 'uploads/time-leave/attachments';
    ...
    {
        return $this->hasOne(LeaveRequestApproval::class, 'leave_request_id', 'id')->where('type', 'short_leave');
    }
}
