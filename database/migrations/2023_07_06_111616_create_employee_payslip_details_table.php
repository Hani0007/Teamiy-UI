...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('employee_payslip_details', function (Blueprint $table) {
            $table->id();
            $table->foreignId('employee_payslip_id')->constrained('employee_payslips')->onDelete('cascade');
            $table->foreignId('salary_group_id')->nullable()->constrained('salary_groups')->onDelete('cascade');
