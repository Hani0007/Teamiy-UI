...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('team_meeting_members', function (Blueprint $table) {
            ...
            $table->foreign('team_meeting_id')->references('id')->on('team_meetings')->onDelete('cascade');
            $table->foreign('meeting_participator_id')->references('id')->on('users')->onDelete('cascade');
